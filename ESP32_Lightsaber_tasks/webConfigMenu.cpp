...
WebConfigMenu::WebConfigMenu() {
}

void WebConfigMenu::readConfig() {
...
void WebConfigMenu::runWebConfigMenu(bool mainButtonPressed, bool secondaryButtonPressed) {
  switch (config_state) {
...
void WebConfigMenu::saveWebConfigMenu() {
